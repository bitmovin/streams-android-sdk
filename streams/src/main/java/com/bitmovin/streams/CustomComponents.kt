    ...
    Dialog(
        ...
        content = {
            ...
            if (isImmersive) {
                ...
                LaunchedEffect(LocalConfiguration.current, width) {
                    for (i in 0..12) {
                        ...
                        if (activityWindow != null &&
                            (activityWindow.decorView.width != width || activityWindow.decorView.height != height)
                        ) {
                ...
                // height is not required since both will be updated anyway if there is a change
                key(width) {
