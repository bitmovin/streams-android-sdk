 ...
 * @property autoRotate Whether the player should automatically change orientation.
 * @property minAspectRatioForLandScapeForce The minimum aspect ratio for forcing landscape orientation. Does not apply if autoRotate is false.
 * @property maxAspectRatioForPortraitForce The maximum aspect ratio for forcing portrait orientation. Does not apply if autoRotate is false.
